...
Na aula 3, Visualização de Dados, foi desenvolvido um dashboard interativo utilizando Streamlit, Plotly e Pandas em Python. O projeto incluiu a criação de um ambiente virtual, instalação de dependências, carregamento de dados e construção de filtros interativos para análise salarial na área de dados.

Na aula 4, Construa um Dashboard Interativo, foram criadas métricas e gráficos interativos, como gráficos de barras, histogramas, gráficos de pizza e mapas geográficos, permitindo visualizar salários, cargos e modelos de trabalho. Por fim, o dashboard foi preparado para publicação na plataforma Streamlit Cloud, demonstrando a integração entre análise de dados e desenvolvimento de aplicações interativas.
